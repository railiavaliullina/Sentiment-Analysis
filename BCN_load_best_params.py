...
def model(x_train, y_train, x_test, y_test, x_valid, y_valid):
    ...
    sess = tf.Session()
    train_writer = tf.summary.FileWriter('C:/Users/Admin/PycharmProjects/Elmo/tensorboard/BCN_load_best_params_tensorboard',
                                         sess.graph)
    ...
    saver.restore(sess, tf.train.latest_checkpoint('saved_models/BCN_new'))
